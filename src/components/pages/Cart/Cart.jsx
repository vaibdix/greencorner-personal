      ...
      <section className="after:contents-[''] relative z-10 after:absolute after:right-0 after:top-0 after:z-0 after:h-full after:bg-gray-50 xl:after:w-1/3">
        <div className="lg-6 relative z-10 mx-auto w-full max-w-7xl px-4 md:px-5">
          <div className="grid grid-cols-12">
            <div className="col-span-12 w-full pb-8 pt-14 max-xl:mx-auto max-xl:max-w-3xl lg:py-14 lg:pr-8 xl:col-span-8">
              <div className="flex items-center justify-between border-b border-gray-300 pb-8">
                <h2 className="font-manrope text-2xl font-semibold leading-10 text-black">
                  Shopping Cart
                </h2>
                <h2 className="font-manrope text-xl font-bold leading-8 text-gray-600">{cart.length} Items</h2>
              </div>
              ...
              {/* Cart Items */}
              {cart.map((item) => (
                <div key={item.id} className="group flex flex-col gap-5 border-b border-gray-200 py-6 min-[500px]:flex-row min-[500px]:items-center">
                  ...
                  <div className="grid w-full grid-cols-1 md:grid-cols-4">
                    ...
                    <div className="flex h-full items-center max-md:mt-3 max-[500px]:justify-center">
                      <div className="flex h-full items-center">
                        ...
                        <input
                          type="text"
                          className="w-full min-w-[60px] max-w-[73px] border-y border-gray-200 bg-transparent py-[15px] text-center text-lg font-semibold"
                          value={item.quantity}
                    ...
                    <div className="flex h-full items-center max-md:mt-3 max-[500px]:justify-center md:justify-end">
                      <p className="text-center text-lg font-bold leading-8 text-gray-600">
            ...
            <div className="col-span-12 mx-auto w-full max-w-3xl bg-gray-50 py-14 max-xl:px-6 lg:pl-8 xl:col-span-4 xl:max-w-lg">
              <h2 className="font-manrope border-b border-gray-300 pb-8 text-2xl font-semibold leading-10 text-black">
                Order Summary
              </h2>
              <div className="mt-8">
                <form>
                  <div className="flex items-center justify-between py-2">
                    ...
                    <p className="text-md font-semibold leading-8 text-[#1c3035]">₹{cartTotal}</p>
                  </div>
