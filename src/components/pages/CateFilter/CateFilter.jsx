...
//       {/* Filtered Plant Cards (Main Content) */}
//       <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
//         {currentPlants.map((plant) => (
//           <PlantCard
//             key={plant.id}
...
//           new Set(data.flatMap((plant) => plant.categories))
//         );
//         setCategories(uniqueCategories);

//         // Set initial price range
//         const prices = data.map((plant) => plant.price);
//         setPriceRange({
//           min: Math.min(...prices),
//           max: Math.max(...prices),
//         });
...
//       {/* Product Cards */}
//       <div className="grid p-10 grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
//         {currentPlants.map((plant) => (
//           <PlantCard
//             key={plant.id}
//             name={plant.name}
