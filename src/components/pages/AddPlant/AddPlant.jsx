...
const [newReview, setNewReview] = useState({
  ...
  const handleAddReview = () => {
    if (newReview.username && newReview.comment) { // Changed from reviewerName and reviewText
      setPlantData((prev) => ({
        ...prev,
      ...
      <div className="mx-auto max-w-4xl rounded-lg bg-white p-8 shadow-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-4">
                <button
                  ...
                  className="rounded-md bg-[#1c3035] px-4 py-2 text-sm font-medium text-white shadow-xs hover:bg-[#1c3035] focus:outline-hidden focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
                >
                  Add Review
                </button>
              </div>
          ...
          <div className="flex justify-end space-x-4">
            <button
              type="button"
              className="rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-xs hover:bg-gray-50 focus:outline-hidden focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
            >
              Cancel
            </button>
            <button
