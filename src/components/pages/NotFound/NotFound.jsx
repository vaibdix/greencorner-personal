  ...
  return (
    <section class="">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="inline-flex w-full flex-col items-center justify-start gap-10 pb-12 pt-12 lg:gap-16 lg:pb-28 lg:pt-[180px]">
          <div class="h-[550px] w-full rounded-lg border border-indigo-300">
            ...
            <div class="relative flex h-[calc(550px-85px)] flex-col items-center justify-center">
              ...
              <div class="mt-5 block text-center">
                <h5 class="mb-1.5 text-lg font-medium leading-8 text-gray-900 md:text-xl">
                  <span class="font-semibold text-indigo-600">Oops!</span> It seems like you've
                  taken a wrong turn
                </h5>
