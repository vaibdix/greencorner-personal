...
const CardFiveProduct = () => {
  ...
  // Get 5 random plants
  const getRandomPlants = (plants, count) => {
    const shuffled = [...plants].sort(() => 0.5 - Math.random());
    return shuffled.slice(0, count);
  };

  const bestSellerPlants = getRandomPlants(plants, 5);
  ...
  return (
    <>
      <h3 className="mt-12 pl-4 text-2xl sm:pl-14 sm:text-3xl">Related Plants</h3>
      <div className="-mb-20 grid grid-cols-2 gap-3 p-2 sm:grid-cols-2 sm:gap-7 sm:p-14 md:grid-cols-3 lg:grid-cols-5">
...
export default CardFiveProduct;
